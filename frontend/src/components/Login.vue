            ...
            <div class="signin-panel">
                ...
                <el-form :model="form" :rules="rules" ref="formRef">
                    <el-form-item prop="id">
                        <el-input prefix-icon="User" placeholder="用户名" v-model="form.id"></el-input>
                    </el-form-item>
                    <el-form-item prop="password">
                        <el-input prefix-icon="Lock" placeholder="密码" show-password v-model="form.password"></el-input>
                    </el-form-item>

                    <el-form-item>
                        <el-button type="primary" class="signin-btn" @click="onLogin">
                            登录
                        </el-button>
                    </el-form-item>
                </el-form>
